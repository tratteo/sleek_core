...
const emit = defineEmits<{ (ev: "changed", open: boolean): void }>();
...
<style scoped>
.collapse-container {
    @apply w-full rounded-box border border-base-content/20 bg-base-100 overflow-hidden;
}

.collapse-trigger {
    @apply bg-base-100 justify-between flex p-4 items-center;
}
</style>
